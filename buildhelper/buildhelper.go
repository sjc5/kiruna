...
func (inst *Helper) mustCommonBuild(isDev bool) {
...
func (inst *Helper) mutateStatements(statements *tsgen.Statements) *tsgen.Statements {
	a := statements
	if a == nil {
		a = &tsgen.Statements{}
	}
